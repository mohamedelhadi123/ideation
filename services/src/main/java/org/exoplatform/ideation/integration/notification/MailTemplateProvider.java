...
@TemplateConfigs(templates = {
        @TemplateConfig(pluginId = IdeaCommentPlugin.ID, template = "war:/notification/templates/mail/IdeaCommentedPlugin.gtmpl"),
})
public class MailTemplateProvider extends TemplateProvider {
    ...
    public MailTemplateProvider(InitParams initParams) {
        ...
        this.templateBuilders.put(PluginKey.key(IdeaCommentPlugin.ID), new CommentTemplateBuilder());
    }
