...
@TemplateConfigs(
   templates = {
       ...
       @TemplateConfig( pluginId = UpdateIdeaPlugin.ID, template="war:/notification/templates/web/UpdateIdeaPlugin.gtmpl"),
           @TemplateConfig( pluginId = AddCommentPlugin.ID, template="war:/notification/templates/web/AddCommentPlugin.gtmpl")
...
public class WebTemplateProvider extends TemplateProvider {
  ...
  public WebTemplateProvider(InitParams initParams) {
    ...
    this.templateBuilders.put(PluginKey.key(UpdateIdeaPlugin.ID), new TemplateBuilder());
    this.templateBuilders.put(PluginKey.key(AddCommentPlugin.ID), new TemplateBuilder());
  ...
  private class TemplateBuilder extends AbstractTemplateBuilder {
    ...
    protected MessageInfo makeMessage(NotificationContext ctx) {
      ...
      String CommentCreator=notification.getValueOwnerParameter(NotificationUtils.COMMENT_CREATOR);
      ...
      if(CommentCreator==null){
        ...
        identity = identityManager.getOrCreateIdentity(OrganizationIdentityProvider.NAME, CommentCreator, true);
      ...
      templateContext.put("IDEA_CREATOR",creator);
      templateContext.put("COMMENT_CREATOR",CommentCreator);
